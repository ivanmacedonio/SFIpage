    ...
    >
      <div className="page3">
        ...
        <div className="pasosp3">
          ...
          >
            <div className="contf" style={{ display: "flex" }}>
              ...
              <div className="textpasos">
                <div className="card">
                  ...
                  <p>
                    ...
                    selecciona un nombre de usuario y contraseña, mientras
                    esperas la validación y aprobación de tu perfil.{" "}
                  </p>
                </div>
                <div className="card">
                  <h1>Selecciona tu Membresía:</h1>
                  <p>
                    Explora nuestras opciones de membresía y elige la que se
                    adapte mejor a tus necesidades y objetivos
                  </p>
                </div>
                <div className="card">
                  <h1>Acceso:</h1>
                  <p>
                    Una vez que te conviertas en miembro, tendrás acceso a una
                    amplia gama de beneficios, incluyendo a sesiones sobre
                    educación de alta calidad, asesoramiento dentro del blog de
                    la comunidad de SFI y la oportunidad de participar en
                    proyectos que asegurarán tus años futuros.{" "}
                  </p>
                </div>
                <div className="card">
                  <h1>Pago con Activos Digitales:</h1>
                  <p>
                    Realiza el pago de tu membresía mensual utilizando tu wallet
                    de activos digitales. Nuestro sistema seguro te guiará a
                    través del proceso.{" "}
                  </p>
                </div>
              </div>
        ...
        <div className="razonescontainer">
          <div className="razones">
            <ul>
              <li>
                El plan de membresías es una forma eficiente de poder asegurar
                tu futuro.
              </li>
              <li>
                Decide cuál es el modelo de membresía entre nuestra gama de
                planes y haz las aportaciones que más te convengan
              </li>
              <li>Comienza tu membresía desde tan solo 84 USDT al mes.</li>
              <li>Realizar membresías periódicas o sumas únicas. </li>
              <li>
                Cualquiera puede realizar el aporte de tu membresía para
              ...
              <li>
                ...
                percibir la tranquilidad prospera que solo SFI le puede ofrecer
              </li>
